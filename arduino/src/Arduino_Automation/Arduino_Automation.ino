...
void arduinoWebserver() {
  ...
  <style type = ""text/css"">\
  \
    body {background-image : url(""http://www.iotbpm.com/wp-content/uploads/2021/05/Arduino_Logotype-763x354.jpg""); background-repeat : no-repeat; background-color : powderblue;}\
